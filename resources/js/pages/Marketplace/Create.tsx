...
export default function Create() {
  const { farms, flash } = usePage<CreatePageProps>().props;
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    post('/marketplace', {
      onSuccess: () => {
        toast.success('Marketplace item listed successfully!');
      },
      onError: () => {
        toast.error('Failed to list item. Please check the form.');
      },
    });
  };
  ...
  return (
    <div className="max-w-xl mx-auto space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">List New Marketplace Item</h1>
